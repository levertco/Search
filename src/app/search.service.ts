...
export class SearchService {
  ...
  getUser(name) {
    ...
    let promise = new Promise((resolve,reject) => {
      this.http.get<ApiData>(`https://api.github.com/users/${name}?access_token=7f4df753304531affb6d4d992cffe1979eab8dc8`).toPromise().then(data => {
  ...
  getRepo(name) {
    ...
    let repos = [];
    let promise = new Promise((resolve,reject) => {
      this.http.get<ApiData>(`https://api.github.com/users/levertco/repos?access_token=7f4df753304531affb6d4d992cffe1979eab8dc8`).toPromise().then(response => {
